  ...
  return (
    <div className="h-full flex-shrink-0 w-[300px] bg-gray-800 rounded-xl p-4 flex flex-col shadow-lg transition-transform transform hover:scale-105">
        ...
        <div className="flex gap-3 mt-auto">
            <button className="w-full bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-200 ease-in-out focus:outline-none focus:ring focus:ring-green-300">Failed</button>
        </div>
    </div>
  )
}
